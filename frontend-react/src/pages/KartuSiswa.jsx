...
export default function KartuSiswa() {
  ...
  const renderCard = (siswa, isBack = false) => {
    ...
    const cardContent = isPortrait ? (
      <div className={`${containerClasses}`} style={{ transform: 'rotate(90deg)', width: '56mm', height: '87.6mm', transformOrigin: 'center', flexShrink: 0 }}>
         <div className="absolute inset-0 z-0" style={{ backgroundImage: bgUrl ? `url(${bgUrl})` : 'none', backgroundSize: 'cover', backgroundColor: `${bgColor}10` }}></div>
         ...
         {!isBack ? (
            <div className="flex flex-col h-full w-full p-3 pt-4 z-0 relative">
               <div className="flex items-center justify-end gap-1.5 w-full mb-2 shrink-0">
                  <div className="flex flex-col text-right border-b-[1.5px] pb-0.5" style={{ borderColor: bgColor }}>
                     <span className="text-[7.5px] font-extrabold uppercase leading-tight" style={{ color: bgColor }}>SMP IT HIDAYATUL MUBTADI-IEN</span>
                     <span className={`text-[5px] ${textColorSub} font-medium leading-tight mt-[1px]`}>Sukaseneng - Compreng - Subang</span>
                  </div>
                  {settings.showFields.schoolLogo && <img src="https://www.e-ujian.com/smpithm/logo" className="w-7 h-7 object-contain shrink-0" />}
               </div>
               ...
               <div className="flex flex-col items-center flex-1 w-full">
                  ...
                  <h3 className={`text-[11.5px] font-bold ${textColorMain} text-center uppercase leading-snug line-clamp-2 w-full px-1`}>{siswa.nama}</h3>
                  <p className={`text-[7px] ${textColorMuted} font-bold tracking-wider mt-0.5 border-b ${isDark ? 'border-gray-600' : 'border-gray-200'} pb-0.5 mb-1 text-center mx-auto w-2/3`}>PESERTA DIDIK</p>
                  
                  <table className={`text-[6.5px] w-full ${textColorMain} leading-tight mt-1`}>
                     <tbody>
                     <tr><td className="w-[12mm] font-bold align-top">NIPD</td><td className="w-[2mm] align-top">:</td><td className="align-top font-bold" style={{ color: bgColor }}>{siswa.nipd || '-'}</td></tr>
                  ...
                  {settings.showFields.signature && (
                    <div className="mt-auto w-full flex justify-end items-end mb-1 shrink-0 px-2">
                        <div className="flex flex-col items-center text-center">
                            <p className={`text-[5.5px] ${textColorSub}`}>Kepala Sekolah,</p>
                            <div className="w-[24mm] h-[10mm] flex items-center justify-center my-0.5 relative opacity-80">
                                <div className="italic text-[6px] text-blue-800 font-serif border-b border-gray-400">Abdul Manaf, S.Pd.</div>
                            </div>
                        </div>
                    </div>
                  )}
            ...
            <div className="flex flex-col h-full w-full p-4 pt-5 z-0 relative text-center">
               <div className="mb-4 shrink-0">
                  ...
                  <ul className={`text-[7.5px] ${textColorSub} space-y-1.5 text-left w-full list-decimal pl-4 pr-1 leading-relaxed`}>
      ...
      // Landscape Layout
      <div className={`${containerClasses} w-[87.6mm] h-[56mm] flex ${isBack ? 'flex-row-reverse' : 'flex-col'}`}>
         <div className="absolute inset-0 z-0" style={{ backgroundImage: bgUrl ? `url(${bgUrl})` : 'none', backgroundSize: 'cover', backgroundColor: `${bgColor}10` }}></div>
         ...
         {!isBack ? (
            <div className="flex flex-col h-full w-full p-3 pl-4 z-0 relative">
               <div className={`flex items-center justify-end gap-2 w-full mb-1 shrink-0 border-b-[4px] pb-1 border-opacity-40`} style={{ borderBottomColor: bgColor }}>
                  <div className="flex flex-col text-right">
                     <span className="text-[10px] font-extrabold uppercase leading-tight" style={{ color: bgColor }}>SMP IT HIDAYATUL MUBTADI-IEN</span>
                     <span className={`text-[6.5px] ${textColorSub} font-medium leading-tight mt-[1px]`}>Sukaseneng - Compreng - Subang</span>
                  </div>
                  {settings.showFields.schoolLogo && <img src="https://www.e-ujian.com/smpithm/logo" className="w-8 h-8 object-contain shrink-0" />}
               </div>
               ...
               <div className="flex flex-1 gap-4 items-center mt-1">
                  ...
                  <div className="flex-1 flex flex-col h-full justify-start py-1">
                     <h3 className={`text-[12.5px] font-extrabold ${textColorMain} uppercase leading-snug line-clamp-1 border-b ${isDark ? 'border-gray-600' : 'border-gray-200'} pb-0.5 mb-1`}>{siswa.nama}</h3>
                     
                     <table className={`text-[7px] w-full ${textColorMain} leading-tight mt-0.5`}>
                        <tbody>
                        <tr><td className="w-[12mm] font-bold align-top">NIPD</td><td className="w-[2mm] align-top">:</td><td className="align-top font-bold" style={{ color: bgColor }}>{siswa.nipd || '-'}</td></tr>
                        <tr><td className="font-bold align-top">NISN</td><td className="align-top">:</td><td className="align-top">{siswa.nisn || '-'}</td></tr>
                        <tr><td className="font-bold align-top">TTL</td><td className="align-top">:</td><td className="align-top capitalize">{`${(siswa.tempat_lahir || '-').toLowerCase()}, ${formatDate(siswa.tanggal_lahir)}`}</td></tr>
                        ...
                        <div className="mt-auto flex justify-end w-full pr-2 shrink-0">
                           <div className="flex flex-col items-center text-center">
                              ...
                              <div className="w-[24mm] h-[10mm] flex items-center justify-center my-0.5 relative">
                                 <div className="italic text-[6px] text-blue-800 font-serif border-b border-gray-400 mt-2">Abdul Manaf, S.Pd.</div>
                              </div>
                           </div>
                        </div>
                     )}
            ...
            <div className="flex items-center h-full w-full p-3 gap-2 z-0 relative">
               <div className="flex-1 flex flex-col justify-center pl-2">
                  ...
                  <ul className={`text-[7.5px] ${textColorSub} space-y-1.5 list-decimal pl-4 pr-1 leading-relaxed`}>
                     <li>Kartu ini adalah identitas resmi peserta didik.</li>
                     <li>Wajib dibawa dan dipakai selama berada di sekolah.</li>
                     <li>Digunakan untuk presensi kehadiran & administrasi.</li>
                     <li>Apabila hilang atau rusak, melapor kepada pihak sekolah.</li>
                  </ul>
                  <p className={`text-[6px] ${textColorMuted} italic mt-3 font-medium`}>** Berlaku selama menjadi siswa **</p>
               </div>
    ...
    return (
      <div 
        className="flex items-center justify-center shrink-0 w-[87.6mm] h-[56mm]"
        style={settings.mirrorPVC ? { transform: 'scaleX(-1)' } : {}}
      >
        {cardContent}
      </div>
    );
  ...
  return (
    <div className="flex flex-col h-full font-sans">
      ...
      <div className="flex flex-col lg:flex-row gap-8 flex-1 pb-10 overflow-y-auto lg:overflow-hidden print:overflow-visible">
        ...
        <div className="w-full lg:w-1/3 flex flex-col gap-6 print:hidden h-auto lg:overflow-y-auto pr-2 custom-scrollbar">
          ...
          <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-6 flex flex-col gap-4">
             ...
             <div className="grid grid-cols-1 xl:grid-cols-2 gap-4">
                ...
                <div className="flex flex-col gap-1 w-full">
                  <label className="text-[10px] font-bold text-gray-500 uppercase">Tema Warna</label>
        ...
        {/* Right Preview Panel */}
        <div className="w-full lg:flex-1 h-[600px] lg:h-auto overflow-auto bg-gray-200 p-4 lg:p-8 rounded-2xl border-4 border-dashed border-gray-300 flex flex-col items-start lg:items-center custom-scrollbar print:border-none print:bg-white print:p-0 print:overflow-visible relative">
            ...
            >
              {pages.map((pageStudents, pageIndex) => (
                <div key={pageIndex} className="a4-sheet bg-white shadow-xl relative" style={{
                  ...
                  padding: '5mm 0 0 0',
                  display: 'grid',
                  gridTemplateColumns: 'repeat(2, 87.6mm)',
                  gridAutoRows: '56mm',
