      ...
      try {
        ...
        if (dataKelasRes) {
          ...
          if (jadwalRes) {
            ...
            const filteredJadwal = jadwalRes.filter(j => j.kelas_id === dataKelasRes.id || (j.is_istirahat && !j.kelas_id));
                    ...
                    <div className="flex-1">
                      {item.is_istirahat ? (
                        <div className="h-full flex flex-col justify-center">
                          ...
                          <span className="text-xs text-orange-500 font-medium">{item.waktu}</span>
                        </div>
                      ) : (
                        <div>
