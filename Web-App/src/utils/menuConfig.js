...
export const menusConfig = [
  ...
  },
  {
    ...
    items: [
      ...
      { to: "/master-jam", icon: Clock, label: "Master Jam Pelajaran" },
      { to: "/master-jam-presensi", icon: Clock, label: "Master Jam Presensi Siswa" },
      { to: "/master-jam-guru", icon: Clock, label: "Master Jam Kerja Guru" },
  ...
  },
  {
    ...
    items: [
      ...
      { to: "/cetak-qr-presensi-guru", icon: QrCode, label: "Cetak QR Absensi Guru" },
  ...
  },
  {
    group: "Keuangan",
    items: [
      { to: "/rekap-honor-guru", icon: DollarSign, label: "Rekap Honor Guru" },
